...
CATEGORIES = {
    "GEOPOLITICS": ["war", "military", "border", "diplomat", "treaty", "sanction", "sovereignty", "empire", "strategic"],
    "CYBER & TECH": ["cyber", "hack", "ransomware", "data breach", "ai", "surveillance", "semiconductor", "digital"],
    "GLOBAL ECONOMY": ["trade", "tariff", "supply chain", "inflation", "currency", "market", "imf", "oil", "energy"],
    "LEADERSHIP": ["election", "parliament", "ceo", "resignation", "scandal", "protest", "policy"]
}
...
def generate_reports(data):
    ...
    # --- REPORT 1: THE EXECUTIVE BRIEF (Internal Board Use) ---
...
"""
    ...
    # --- REPORT 2: THE CONTENT STUDIO (Marketing/LinkedIn) ---
...
"""
    ...
    print(f"Success! Enterprise Reports generated:\n1. {BRIEF_FILE}\n2. {CONTENT_FILE}")
